...
/* Перемикання пошуку на моб. пристроях */
...
/**
 * Відображання всіх погодних даних на html-сторінці
 * 
...
fetchData(url.currentWeather(lat, lon), function (currentWeather) {
  ...
  card.innerHTML = `
    <h2 class="title-2 card-title">Зараз</h2>
    ...
    <ul class="meta-list">
      <li class="meta-item">
        ...
        <p class="title-3 meta-text">${dayOfWeek}, ${month} ${date.toLocaleDateString("uk-UA", { day: "numeric" })}</p>
      </li>
  ...
  currentWeatherSection.appendChild(card);
    ...
    fetchData(url.airPollution(lat, lon), function (airPollution) {
      ...
      card.innerHTML = `
        <h2 class="title-2" id="highlights-label">Показники сьогодні</h2>

        <div class="highlight-list">

          <div class="card card-sm highlight-card one">

            <h3 class="title-3">Індекс якості повітря</h3>
          ...
          <div class="card card-sm highlight-card two">
            ...
            <h3 class="title-3">Схід і Захід сонця</h3>
          ...
          <div class="card card-sm highlight-card">
            ...
            <h3 class="title-3">Вологість повітря</h3>
          ...
          <div class="card card-sm highlight-card">
            ...
            <h3 class="title-3">Тиск</h3>

            <div class="wrapper">
              <span class="m-icon">airwave</span>

              <p class="title-1">${pressure}<sub>гПа</sub></p>
            </div>
          ...
          <div class="card card-sm highlight-card">
            ...
            <h3 class="title-3">Відчувається</h3>
    ...
    fetchData(url.forecast(lat, lon), function (forecast) {
      ...
      hourlySection.innerHTML = `
        <h2 class="title-2">Сьогодні о</h2>
      ...
      for (const [index, data] of forecastList.entries()) {
        ...
        <div class="card card-sm slider-card">
          ...
          <p class="body-3">${parseInt(module.mps_to_kmh(windSpeed))} км/год</p>
      ...
      /* РОЗДІЛ ПРОГНОЗУ НА 5 ДНІВ */
      forecastSection.innerHTML = `
        <h2 class="title-2" id="forecast-label">Прогноз на 5 днів</h2>
